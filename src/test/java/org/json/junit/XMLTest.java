...
public class XMLTest {
    ...
    public void test() throws JSONException, Exception {
        String xmlStr = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><bookstore> <book> <title>Harry Potter and the Philosopher's Stone</title> <author>J.K. Rowling</author> <genre>Fantasy</genre> <price>19.99</price> </book> <book> <title>The Hobbit</title> <author>J.R.R. Tolkien</author> <genre>Fantasy</genre> <price>14.99</price> </book> <book> <title>1984</title> <author>George Orwell</author> <genre>Dystopian</genre> <price>12.99</price> </book></bookstore>";
        JSONObject jo = new JSONObject();
        jo = XML.toJSONObject(new StringReader(xmlStr), new JSONPointer("/bookstore/book/title"));
        String json = "{\"title\":\"Harry Potter and the Philosopher\'s Stone\"}";
    ...
    public void test2() throws JSONException, Exception {
        ...
        JSONObject jo = new JSONObject();
        jo = XML.toJSONObject(new StringReader(xmlStr), new JSONPointer("/root/cars/car/1"));
        String json = "{\"car\":\"BMW\"}";
        JSONObject expected = new JSONObject(json);
        assertTrue(expected.similar(jo));
    }
    ...
    public void test3() throws JSONException, Exception {
        String xmlStr = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                ...
                "</contact>";
        JSONObject jo = new JSONObject();
        jo = XML.toJSONObject(new StringReader(xmlStr), new JSONPointer("/contact/address/street/"));
